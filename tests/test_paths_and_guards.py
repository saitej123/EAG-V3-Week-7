...
from cognitive_rag.paths import SANDBOX, resolve_sandbox_subdir
from cognitive_rag.schemas import Goal, MemoryItem
from cognitive_rag.search_providers import heuristic_tool_call
...
def test_catalog_stats_pdf_alias(tmp_path, monkeypatch):
    from cognitive_rag import catalog, indexing, paths
    from cognitive_rag.catalog import IndexedDocumentRecord, _index_record_for_path
...
def test_enrich_index_document_keeps_pdf_path_with_sidecar(tmp_path, monkeypatch):
    from cognitive_rag import indexing, paths
    from cognitive_rag.schemas import Goal, ToolCall
    from cognitive_rag.search_providers import enrich_tool_call
