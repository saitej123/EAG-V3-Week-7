...
DESIGN_DEFERRALS: list[DesignDeferral] = [
    DesignDeferral(
        ...
        where="cognitive_rag/memory.py — vector-first read()",
    ...
    DesignDeferral(
        ...
        where="cognitive_rag/indexing.py — _chunk_text(), index_document_path()",
    ...
    DesignDeferral(
        ...
        where="cognitive_rag/memory.py — _load_faiss_from_disk()",
        forward_phase="Future release",
    ...
    DesignDeferral(
        ...
        where="cognitive_rag/llm_env.py — gemini_embed_model(), try_embed_text()",
        forward_phase="Future release",
